...
describe('TeamList Component', () => {
  ...
  test('renders team member bios', () => {
    ...
    const bio1 = screen.getByText(/Full-stack developer with 10 years experience/);
    const bio2 = screen.getByText(/Creative designer passionate about user experience/);
  ...
  test('has proper accessibility structure', () => {
    ...
    const teamSection = screen.getByRole('list') || screen.getByTestId('team-list');
    if (teamSection) {
