...
describe('AboutOffer Component', () => {
  ...
  test('displays offer-related content', () => {
    ...
    expect(screen.getByText(/commit your code conference/i)).toBeInTheDocument();
  ...
  test('may display multiple offerings or services', () => {
    ...
    const serviceTerms = [
      /training/i, /education/i, /course/i, /program/i,
      /workshop/i, /bootcamp/i, /mentoring/i, /coaching/i,
      /consultation/i, /support/i, /guidance/i, /development/i
    ];
  ...
  test('may include pricing or feature information', () => {
    ...
    const commercialTerms = [
      /price/i, /cost/i, /free/i, /premium/i,
      /feature/i, /benefit/i, /included/i, /access/i
    ];
