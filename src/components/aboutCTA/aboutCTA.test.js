...
describe('AboutCTA Component', () => {
  ...
  test('renders call-to-action subtitle', () => {
    ...
    const subtitleElement = screen.getByText('Take the first step towards advancing your career and connecting with amazing developers');
  ...
  test('buttons have correct href attributes', () => {
    ...
    const joinButton = screen.getByRole('link', { name: /join the community/i });
