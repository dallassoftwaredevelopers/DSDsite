...
describe('AboutTeam Component', () => {
  ...
  test('displays team-related content', () => {
    ...
    expect(screen.getByText(/dedicated admin team volunteers/i)).toBeInTheDocument();
  });
  ...
  test('may render team member information', () => {
    ...
    const memberTitles = screen.queryByText(/developer/i) || 
  ...
  test('may include team description or values', () => {
    ...
    const teamDescription = screen.queryByText(/culture/i) || 
