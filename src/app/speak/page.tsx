            ...
            <div className={styles.heroStats}>
              <div className={styles.stat}>
                <span className={styles.statNumber}>
                  {LABELS.speak.hero.stats.audience}
                </span>
                <span className={styles.statLabel}>
                  {LABELS.speak.hero.stats.audienceLabel}
                </span>
              </div>
              <div className={styles.stat}>
                <span className={styles.statNumber}>
                  {LABELS.speak.hero.stats.meetups}
                </span>
                <span className={styles.statLabel}>
                  {LABELS.speak.hero.stats.meetupsLabel}
                </span>
              </div>
              <div className={styles.stat}>
                <span className={styles.statNumber}>
                  {LABELS.speak.hero.stats.speakers}
                </span>
                <span className={styles.statLabel}>
                  {LABELS.speak.hero.stats.speakersLabel}
                </span>
              </div>
            </div>
