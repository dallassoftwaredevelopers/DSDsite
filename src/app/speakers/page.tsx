    ...
    <main style={{ padding: '2rem' }}>
      ...
      <section
        style={{
          marginTop: '4rem',
          padding: '3rem 2rem',
          background: 'linear-gradient(135deg, rgba(60, 60, 185, 0.1) 0%, rgba(69, 71, 201, 0.05) 100%)',
          borderRadius: '16px',
          textAlign: 'center',
      ...
      >
        ...
        <p style={{ color: 'var(--cool-gray)', marginBottom: '1.5rem', maxWidth: '500px', margin: '0 auto 1.5rem' }}>
