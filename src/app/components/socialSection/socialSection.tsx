      ...
      <div className={styles.socialContent}>
        <div className={styles.socialText}>
          <h2 className={styles.socialHeading}>
            Join our <span className={styles.highlight}>Discord</span> and other social links!
          </h2>
          <p className={styles.socialSubheading}>
            This is YOUR community, be a part of it! Connect with fellow developers, share knowledge, and grow together.
          </p>
          <div className={styles.ctaContainer}>
            <a href="https://discord.gg/dallassoftwaredevs" target="_blank" rel="noopener noreferrer" className={styles.discordCta}>
