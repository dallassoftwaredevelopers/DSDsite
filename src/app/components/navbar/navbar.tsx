      ...
      <div className={styles.container}>
        <div className={styles.navbarContent}>
          <Link href="/" className={styles.logoLink}>
            <div className={styles.logoWrapper}>
              <Image
                ...
                alt="Dallas Software Developers Logo"
                width={50}
                height={50}
                className={styles.logo}
              />
              <span className={styles.logoText}>Dallas Software Developers</span>
            </div>
          </Link>
          ...
          <nav className={styles.desktopNav}>
            ...
            >
              <span className={styles.ctaText}>Join Meetup</span>
      ...
      <div className={`${styles.mobileNav} ${isNavVisible ? styles.visible : ''}`}>
        <div className={styles.mobileNavContent}>
          ...
          <div className={styles.mobileNavFooter}>
            ...
            <p className={styles.mobileNavCopyright}>© {new Date().getFullYear()} Dallas Software Developers</p>
          </div>
        </div>
      </div>
    </header>
