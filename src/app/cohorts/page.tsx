  ...
  2022: [
    {
      ...
      projectDescription: 'A platform connecting junior developers with mentors in the Dallas tech community'
    },
    {
      id: 2,
      cohortName: 'Cohort 6',
      ...
      projectDescription: 'A community event management system for local tech meetups'
    },
  ],
  2023: [
    {
      ...
      projectDescription: 'A tool for developers to track their learning progress and showcase skills'
    },
    {
      id: 2,
      cohortName: 'Cohort 8',
      ...
      projectDescription: 'A collaborative coding platform for remote pair programming sessions'
    },
  ],
  2024: [
    {
      ...
      projectDescription: 'A job board connecting Dallas tech companies with local developer talent'
    },
  ],
};
...
const programFeatures = [
  {
    ...
    description: 'Build a deployable MVP that you can showcase in your portfolio. Past projects include job boards, community platforms, and developer tools that solve actual problems in the Dallas tech ecosystem.',
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.5c-5.25 0-9.5 4.25-9.5 9.5s4.25 9.5 9.5 9.5 9.5-4.25 9.5-9.5-4.25-9.5-9.5-9.5zm-1 14.5v-4h-3l4-7v4h3l-4 7z"/></svg>
  },
  {
    title: 'Industry Mentorship',
    description: 'Gain one-on-one guidance from professional software developers working at companies like Toyota Connected, Capital One, and Texas Instruments. Our mentors provide code reviews, architecture advice, and career coaching.',
  ...
  },
  {
    ...
    description: 'Experience real sprint planning, daily standups, and retrospectives just like professional teams. Learn to use industry tools like GitHub, Jira, and Figma in a collaborative environment.',
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2c5.514 0 10 4.486 10 10s-4.486 10-10 10-10-4.486-10-10 4.486-10 10-10zm0-2c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm5.848 12.459c.202.038.202.333.001.372-1.907.361-6.045 1.111-6.547 1.111-.719 0-1.301-.582-1.301-1.301 0-.512.77-5.447 1.125-7.445.034-.192.312-.181.343.014l.985 6.238 5.394 1.011z"/></svg>
  },
  {
    title: 'Peer Community',
    description: 'Connect with a diverse cohort of developers from across DFW and beyond. Many participants have formed lasting professional relationships and even landed jobs through connections made during the program.',
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M17.997 18h-.998c0-1.552.06-1.775-.88-1.993-1.438-.332-2.797-.645-3.293-1.729-.18-.396-.301-1.048.155-1.907 1.021-1.929 1.277-3.583.702-4.538-.672-1.115-2.707-1.12-3.385.017-.576.968-.316 2.613.713 4.512.465.856.348 1.51.168 1.908-.49 1.089-1.836 1.4-3.262 1.728-.982.227-.92.435-.92 2.002h-.995l-.002-.623c0-1.259.1-1.985 1.588-2.329 1.682-.389 3.344-.736 2.545-2.209-2.366-4.365-.676-6.839 1.865-6.839 2.492 0 4.227 2.383 1.867 6.839-.775 1.464.824 1.812 2.545 2.209 1.49.344 1.589 1.072 1.589 2.333l-.002.619zm4.81-2.214c-1.289-.298-2.489-.559-1.908-1.657 1.77-3.342.47-5.129-1.4-5.129-1.265 0-2.248.817-2.248 2.325 0 1.269.574 2.175.904 2.925h1.048c-.17-.75-1.466-2.562-.766-3.736.412-.692 1.704-.693 2.114-.012.38.631.181 1.812-.534 3.161-.388.733-.28 1.301-.121 1.648.305.666.977.987 1.737 1.208 1.507.441 1.368.042 1.368 1.48h.997l.002-.463c0-.945-.074-1.492-1.193-1.75zm-22.805 2.214h.997c0-1.438-.139-1.039 1.368-1.48.761-.221 1.433-.542 1.737-1.208.159-.348.267-.915-.121-1.648-.715-1.349-.914-2.53-.534-3.161.41-.682 1.702-.681 2.114.012.7 1.175-.596 2.986-.766 3.736h1.048c.33-.75.904-1.656.904-2.925.001-1.509-.982-2.326-2.247-2.326-1.87 0-3.17 1.787-1.4 5.129.581 1.099-.619 1.359-1.908 1.657-1.12.258-1.194.805-1.194 1.751l.002.463z"/></svg>
  }
];
...
const whoShouldJoin = [
  {
    ...
    description: 'Whether you\'re a recent bootcamp grad, CS student, or professional changing careers, our cohorts provide the real-world experience that employers in Dallas-Fort Worth are looking for.',
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M5.495 2h16.505v-2h-17c-1.657 0-3 1.343-3 3v18c0 1.657 1.343 3 3 3h17v-20h-16.505c-1.375 0-1.375-2 0-2zm.505 4h14v16h-14v-16z"/></svg>
  },
  {
    title: 'Time Commitment',
    description: 'Commit approximately 8–12 hours per week to teamwork, coding sprints, and mentorship sessions. We schedule around typical work hours to accommodate those with full-time jobs.',
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2c5.514 0 10 4.486 10 10s-4.486 10-10 10-10-4.486-10-10 4.486-10 10-10zm0-2c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm5.848 12.459c.202.038.202.333.001.372-1.907.361-6.045 1.111-6.547 1.111-.719 0-1.301-.582-1.301-1.301 0-.512.77-5.447 1.125-7.445.034-.192.312-.181.343.014l.985 6.238 5.394 1.011z"/></svg>
  },
  {
    title: 'Technical Foundation',
    description: 'You should be comfortable with core web or mobile technologies (e.g., JavaScript, React, C#, .NET, Java, Swift) and eager to work with tools like GitHub, Figma, Jira, and VS Code. We don\'t expect mastery, just a willingness to learn.',
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M24 10.935v2.131l-8 3.947v-2.23l5.64-2.783-5.64-2.79v-2.223l8 3.948zm-16 3.848l-5.64-2.783 5.64-2.79v-2.223l-8 3.948v2.131l8 3.947v-2.23zm7.047-10.783h-2.078l-4.011 16h2.073l4.016-16z"/></svg>
  }
];

const programDetails = [
  {
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M20 20h-4v-4h4v4zm-6-10h-4v4h4v-4zm6 0h-4v4h4v-4zm-12 6h-4v4h4v-4zm6 0h-4v4h4v-4zm-6-6h-4v4h4v-4zm16-8v22h-24v-22h3v1c0 1.103.897 2 2 2s2-.897 2-2v-1h10v1c0 1.103.897 2 2 2s2-.897 2-2v-1h3zm-2 6h-20v14h20v-14zm-2-7c0-.552-.447-1-1-1s-1 .448-1 1v2c0 .552.447 1 1 1s1-.448 1-1v-2zm-14 2c0 .552-.447 1-1 1s-1-.448-1-1v-2c0-.552.447-1 1-1s1 .448 1 1v2z"/></svg>,
    title: 'Duration',
    description: 'Six weeks of guided, hands-on development with a structured curriculum and clear milestones'
  },
  {
  ...
  },
  {
    ...
    title: 'Teams',
    description: 'Small squads (4–6 members) led by a professional "Cohort Lead" from companies like Toyota Connected, Capital One, and Texas Instruments'
  }
];
        ...
        <div className={styles.heroContent}>
          <div className={styles.heroTextContent}>
            ...
            <div className={styles.heroDescription}>
              <p>A 6-week collaborative experience where you'll build real projects with a team of developers under the guidance of industry professionals from the Dallas tech scene.</p>
            </div>
        ...
        <div className={styles.contentWrapper}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionDescription}>
              The DSD Cohort program empowers you to join a cross-functional tech team led by professional software developers currently working in the Dallas tech industry. 
              Over the course of six weeks, you&apos;ll collaborate remotely (with priority given to Dallas-area participants) to design, build, and deliver a complete application that solves a tangible problem for the local tech community.
            </p>
          </div>
          ...
          <div className={styles.overviewImageContainer}>
            <div className={styles.overviewImage}>
              ...
              />
              <div className={styles.imageCaption}>Cohort 8 final presentation at the Dallas Software Developers meetup</div>
            </div>
          </div>
        </div>
      </section>
      ...
      >
        <div className={styles.contentWrapper}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionDescription}>To thrive in the DSD Cohort, you should:</p>
          </div>
          ...
          <div className={styles.dallasCallout}>
            ...
            <div className={styles.calloutContent}>
              ...
              <p>While our cohorts are remote-friendly, we have deep connections to the Dallas-Fort Worth tech ecosystem. Many of our mentors work at local companies like Toyota Connected, Capital One, Texas Instruments, and Match Group, providing insights into the local job market and tech culture.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className={styles.contentWrapper}>
          ...
          <div className={styles.programHighlightsGrid}>
            <div className={styles.programHighlightItem}>
              ...
              <p>Past cohorts have created job boards for the Dallas tech community, mentorship platforms connecting junior and senior developers, event management systems for local meetups, and developer tools that solve real problems.</p>
            </div>
            <div className={styles.programHighlightItem}>
              <h3>Who You&apos;ll Meet</h3>
              <p>Your cohort lead will be an experienced developer currently working in the industry. Past leads have come from companies like Toyota Connected, Capital One, Texas Instruments, and Match Group.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      >
        <div className={styles.contentWrapper}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionDescription}>
              We follow a professional agile development process that mirrors what you&apos;ll experience in the industry
            </p>
          </div>
            ...
            {weeklyStructure.map((week, index) => (
              <div key={index} className={styles.timelineItem}>
                ...
                <div className={styles.timelineContent}>
                  <h3><span className={styles.weekLabel}>{week.week}:</span> {week.title}</h3>
                  <ul>
          ...
          <div className={styles.scheduleNote}>
            ...
            <p>We understand that many participants have full-time jobs or other commitments. Most cohort activities happen in the evenings and weekends, with asynchronous work in between. Your team will establish a schedule that works for everyone.</p>
          </div>
        </div>
      </section>
            ...
            >
              <div className={styles.contentWrapper}>
                <div className={styles.sectionHeader}>
                  ...
                  <p className={styles.sectionDescription}>
                    Watch presentations from our previous cohorts showcasing their completed projects
                  </p>
                </div>
      ...
      <section
        ...
        <div className={styles.contentWrapper}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionDescription}>
              Hear from our alumni who have transformed their careers through the DSD Cohort program
            </p>
          </div>
          ...
          <div className={styles.careerOutcomes}>
            ...
            <div className={styles.outcomesStats}>
              <div className={styles.outcomeStat}>
                ...
                <span className={styles.outcomeLabel}>of participants reported that the cohort experience helped them land a job or promotion</span>
              </div>
              <div className={styles.outcomeStat}>
                <span className={styles.outcomeNumber}>85%</span>
                <span className={styles.outcomeLabel}>said the cohort gave them confidence in technical interviews</span>
              </div>
              <div className={styles.outcomeStat}>
                <span className={styles.outcomeNumber}>90%</span>
                <span className={styles.outcomeLabel}>would recommend the program to other developers</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={styles.contentWrapper}>
          <div className={styles.applicationSection}>
            <div className={styles.sectionHeader}>
              ...
              <p className={styles.sectionDescription}>
                Ready to level up your developer skills and build something meaningful with the Dallas tech community?
              </p>
            </div>
                  ...
                  <ol className={styles.stepsList}>
                    <li>
                      ...
                      <div className={styles.stepContent}>
                        ...
                        <p>Fill out a brief form telling us about your background and why you want to join</p>
                      </div>
                    </li>
                    <li>
                      ...
                      <div className={styles.stepContent}>
                        ...
                        <p>Complete a small coding challenge to demonstrate your current skill level</p>
                      </div>
                    </li>
                    <li>
                      ...
                      <div className={styles.stepContent}>
                        ...
                        <p>Chat with a cohort lead about your goals and expectations</p>
                      </div>
                    </li>
                    <li>
                      ...
                      <div className={styles.stepContent}>
                        ...
                        <p>If selected, you&apos;ll be matched with a team based on your skills and interests</p>
                      </div>
                    </li>
                  </ol>
                  <Button
              ...
              {currentCohortStatusData.statusType === 'closed' && (
                <div className={styles.notificationFormWrapper}>
                  ...
                  <div className={styles.joinDiscord}>
                    <p>In the meantime, join our Discord community to connect with past cohort participants and mentors:</p>
                    <a
...
function TestimonialsCarousel({ testimonials }: { testimonials: any[] }) {
  ...
  const scrollToIndex = useCallback((index: number) => {
    ...
    const cardWidth = carouselRef.current.querySelector(`.${styles.testimonialCard}`)?.clientWidth || 0;
    ...
    <div className={styles.testimonialsContainer}>
      ...
      >
        {testimonials.map((testimonial, index) => (
          <div key={index} className={styles.testimonialCard} style={{ animationDelay: `${index * 0.2}s` }}>
            ...
            <a href={testimonial.linkedIn} target="_blank" rel="noopener noreferrer" className={styles.linkedinLink}>
