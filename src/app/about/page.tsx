      ...
      <section className={`section bgGray ${styles.openSourceContainer}`}>
        <div className='sectionPadded'>
          ...
          <p className={`sectionParagraph ${styles.openSourceDescription}`}>
            ...
            contributions to open-source code. Our Discord serves as the central
            hub for developers eager to engage in meaningful discussions, seek
          ...
          <p className={`sectionParagraph ${styles.openSourceDescription}`}>
            ...
            tools and resources necessary to get started. Simply head over to
            [x] channel to explore current projects and find one that aligns
            with your interests and expertise. Whether you&apos;re passionate
            about web development, mobile apps, or AI, there&apos;s a project
            waiting for you to make your mark. Join us on Discord and be part of
            a vibrant community dedicated to fostering collaboration and growth
